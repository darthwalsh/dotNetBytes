...
namespace Tests
{
  ...
  public class AssemblyBytesTests
  {
    ...
    //TODO(fixme) Generic attributes were added to .NET runtime: https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/proposals/csharp-11.0/generic-attributes
